...
int main(int nargs, char* argv[])
{
    ...
    Window win("Ant Simulation (OpenMP)", 2*land.dimensions()+10, land.dimensions()+266);
    // copy for rendering
    std::vector<ant> render_ants;
    render_ants.reserve(ants.size());
    ...
    std::cout << "\n========== TIME MEASUREMENTS (OpenMP Version) ==========" << std::endl;
